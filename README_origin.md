...
maze_assets_loc = f"{ROOT_DIR}/environment/frontend_server/static_dirs/assets"
env_matrix = f"{maze_assets_loc}/the_ville/matrix"
env_visuals = f"{maze_assets_loc}/the_ville/visuals"

fs_storage = f"{ROOT_DIR}/environment/frontend_server/storage"
fs_temp_storage = f"{ROOT_DIR}/environment/frontend_server/temp_storage"
