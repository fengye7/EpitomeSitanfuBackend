...
# 引入基本路径
from utils import BASE_PROMPT_PATH
...
def run_gpt_prompt_action_sector(action_description, 
  ...
  gpt_param = {"engine": "gpt-35-turbo-0125", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = os.path.join(BASE_PROMPT_PATH,"persona/prompt_template/v1/action_location_sector_v2.txt")
...
def run_gpt_prompt_action_arena(action_description, 
  ...
  gpt_param = {"engine": "gpt-35-turbo-0125", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = os.path.join(BASE_PROMPT_PATH,"persona/prompt_template/v1/action_location_object_v1.txt")
