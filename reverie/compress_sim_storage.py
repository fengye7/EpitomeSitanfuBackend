...
def compress(sim_code):
  sim_storage = f"{ROOT_DIR}/environment/frontend_server/storage/{sim_code}"
  compressed_storage = f"{ROOT_DIR}/environment/frontend_server/compressed_storage/{sim_code}"
